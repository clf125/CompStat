source("Assignments/Assignment 2/Benchmark_logaffine_vs_gaussian.R")

png("Assignments/Assignment 2/Presentation 2/bench_plot3.png", width = 1100, height = 700)
...
ggplot2::ggsave("Assignments/Assignment 2/Presentation 2/bench_plot4.png", p4, width = 9, height = 6)
...
saveRDS(out, "Assignments/Assignment 2/Presentation 2/best_m.rds")
...
png("Assignments/Assignment 2/Presentation 2/sweep_plot.png", width = 1600, height = 600, res = 130)
